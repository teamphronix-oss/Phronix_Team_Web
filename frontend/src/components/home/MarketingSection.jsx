...
const stats = [
  ...
  { value: "4.8x", label: "avg. paid campaign ROAS" },
  { value: "60+", label: "campaigns launched" },
  { value: "25+", label: "brands positioned" },
];
        ...
        <div className="marketing-stats">
          {stats.map((s) => (
            <div className="marketing-stats__item" key={s.label}>
              <span className="marketing-stats__value">{s.value}</span>
